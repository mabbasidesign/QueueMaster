metadata description = 'OrderService deployment to Azure Container Apps'
...
output name string = orderServiceApp.name
output fqdn string = orderServiceApp.properties.configuration.ingress.fqdn
output url string = 'https://${orderServiceApp.properties.configuration.ingress.fqdn}'
